...
// Song titles
const songs = ['again', 'answerme', 'Bryan','bryannnn', 'cowboy', 'crossed', 'Darkest Place', 'do not rush things' , "don't stop me now", 'flashh', 'got to do it', 'Habiba','Haha groove', 'imdown', 'kavi', 'kazinsky', 'Last Mile', 'Lets Play', 'madamada', 'Move your', 'moveOn', 'next step', 'neww', 'no purpose', 'outstanding', 'pleased_2', 'Project_11', 'Project_29', 'Project_33', 'Project_40', 'Project_54', 'Soloing Life', 'stranger', 'Synthwave', 'teddy', 'Through the night', 'To Love You', 'Tonight', 'Vice City', 'waisted', 'watizlov'];
